        ...
        <div class="container bg-white">
            <div class="row">
                <div class="col-sm-8">
                    <br>
                <ul class="nav nav-pills justify-content-center text-dark">
                    <li class="nav-item"><a href="rekap_skripsi_doswal.php" class="nav-link text-dark"><b>Rekap Data Skripsi Mahasiswa</b></a></li>
                    <li class="nav-item"><a href="list_sudah_skripsi_doswal.php" class="nav-link text-dark"><b>Data Mahasiswa Sudah Skripsi</b></a></li>
                    <li class="nav-item"><a href="list_belum_skripsi_doswal" class="nav-link active" aria-current="page" style="background-color:grey"><b>Data Mahasiswa Belum Skripsi</b></a></li>
                </ul>
                    <form method="POST" autocomplete="on" action="">
                        ...
                        if (isset($_POST["upload"])) {
                            $query = klik9($_POST["upload"]);
                        }
                        if (isset($_POST["semua"])) {
                            $query = semua9($_POST["semua"]);
                        }
                        ...
                        <tr>
                            ...
                            <td><?= $mhs["NIM"] ?></td>
                            <td><?= $mhs["nama"] ?></td>
                            <td><a class="btn btn-warning btn-sm" href="data_mhs_doswalblmskripsi.php?id=<?= $mhs["id_mhs"]; ?>">Detail</a>&nbsp;&nbsp;
                            </td>
                        </tr>
                        <?php $i++;?>
                        <?php endforeach; ?>
