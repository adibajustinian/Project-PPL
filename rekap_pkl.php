<?php
    ...
    $query = "SELECT angkatan, status_pkl FROM pkl, mahasiswa WHERE pkl.id_mhs = mahasiswa.id_mhs";
    $result = $db->query($query);

    while ($row = $result->fetch_object()) { //only this is changed
        if ($row->status_pkl == "Belum PKL") {
...
<body style="background-color:#f3f3f3">
    ...
    <div class="me-5 ms-5">
        ...
        <div class="container bg-white">
            <div class="row">
            <ul class="nav nav-pills justify-content-center text-dark">
                    <li class="nav-item"><a href="rekap_pkl.php" class="nav-link active" aria-current="page" style="background-color:grey"><b>Rekap Data PKL Mahasiswa</b></a></li>
