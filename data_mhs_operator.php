<!--
    Nama file: data_mhs_operator.php
        ...
        <?php if ($_GET["id"]  == $mhs["id_mhs"]) { ?>
            ...
            <div class="me-5 ms-5">
                ...
                <ul class="nav nav-pills justify-content-center text-dark">
                    <li class="nav-item-left"><a href="dashboard_operator.php" class="nav-link active" aria-current="page" style="background-color:#101E31"><b>Kembali</b></a></li>
                </ul>
