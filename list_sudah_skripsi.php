<!--
    Nama file: list_sudah_skripsi.php
    fungsi: Halaman untuk departemen melihat data mahasiswa yang sudah lulus skripsi pada sistem
-->
<html lang="en">
        ...
        <div class="container bg-white">
            <div class="row">
                ...
                <ul class="nav nav-pills justify-content-center text-dark">
                    ...
                    <li class="nav-item"><a href="#" class="nav-link active"  aria-current="page" style="background-color:grey"><b>Data Mahasiswa Sudah Skripsi</b></a></li>
                ...
                <form method="POST" autocomplete="on" action="">
                        ...
                        if (isset($_POST["upload"])) {
                            $query = klik6($_POST["upload"]);
                        }
                        if (isset($_POST["semua"])) {
                            $query = semua6($_POST["semua"]);
                        }
