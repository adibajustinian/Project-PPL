...
<body style="background-color:#f3f3f3"">
    ...
    <div class="me-5 ms-5">
        ...
        <ul class="nav nav-pills justify-content-center text-dark">
            ...
            <li class="nav-item"><a href="#" class="nav-link active" aria-current="page" style="background-color:#101E31"><b>Data Mahasiswa</b></a></li>
        ...
        <div class="container bg-white">
            <div class="row">
                ...
                <div class="col-sm">
                    <br>
                <ul class="nav nav-pills justify-content-center text-dark">
                    <li class="nav-item"><a href="list_aktif.php" class="nav-link text-dark"><b>Data Mahasiswa Aktif</b></a></li>
                    <li class="nav-item"><a href="list_tidak_aktif.php" class="nav-link active" aria-current="page" style="background-color:grey"><b>Data Mahasiswa Tidak Aktif</b></a></li>
                </ul>
                    <form method="POST" autocomplete="on" action="">
                        ...
                        if (isset($_POST["upload"])) {
                            $query = klik($_POST["upload"]);
                        }
                        if (isset($_POST["semua"])) {
                            $query = semua($_POST["semua"]);
                        }
