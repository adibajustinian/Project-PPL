<!--
    Nama file: dasboard_departmen.php
    fungsi: Halaman untuk departemen melihat home departemen
-->
<?php
session_start();
...
$query = "SELECT angkatan, status FROM mahasiswa";
    ...
    <div class="me-5 ms-5">
        ...
        <div class="container bg-white">
            ...
            <div class="col-6" style="margin-top: 50px;">
                    <div class="row">
                        <div class="col-3">
                            <img src="logo.jpeg" alt="Informatika Undip" width="200" class="rounded-circle img-thumbnail ms-3 me-3">
                        </div>
                        <div class="col-9" style="margin-top: 15px;">
                            <div class="ms-3">Departemen Informatika</div>
                            <div class="ms-3">Fakultas Sains dan Matematika</div>
                            <div class="ms-3">Universitas Diponegoro</div>
                    ...
                    <div class="row ms-3">
                        <div class="col-6">
                            <div class="card mb-4 text-light" style="width:15rem; height:14rem;background-color:#2F6146;">
                                <div class="card-body text-center">
                                    <h5 class="card-title text-center">Total Mahasiswa Aktif Departemen</h5>
                                    <br>
                                    <h1> 
                                        <?php 
                                        $qry2 = mysqli_query($db,"select * from mahasiswa WHERE status='AKTIF'");
                        ...
                        <div class="col-6">
                            <div class="card text-light" style="width:15rem; height:14rem;background-color:#972126;">
                                <div class="card-body text-center">
                                    <h5 class="card-title text-center">Total Mahasiswa Tidak Aktif</h5>
                                    <br>
                                        <h1>
                                        <?php 
                                        $qry = mysqli_query($db,"select * from mahasiswa WHERE status!='AKTIF'");
                ...
                <div class="container col-6" style="margin-top: 30px;">
                    ...
                    <div class="text-left">
                            ...
                            <div class="nav nav-pills justify-content-center text-dark">
                                <li class="nav-item"><a href="list_aktif.php" class="nav-link active" aria-current="page" style="background-color:#101E31"><b>Lihat Detail Status Mahasiswa</b></a></li>
                            </div>
                        </div>
                </div>
