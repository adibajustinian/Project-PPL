        ...
        <div class="container bg-white">
            <div class="row">
                ...
                <ul class="nav nav-pills justify-content-center text-dark">
                    ...
                    <li class="nav-item"><a href="#" class="nav-link text-dark" class="nav-link active" aria-current="page" style="background-color:grey"><b>Data Mahasiswa Sudah Skripsi</b></a></li>
                    ...
                    <form method="POST" autocomplete="on" action="">
                        ...
                        if (isset($_POST["upload"])) {
                            $query = klik11($_POST["upload"]);
                        }
                        if (isset($_POST["semua"])) {
                            $query = semua11($_POST["semua"]);
                        }
                        ...
                        <tr>
                            ...
                            <td><?= $mhs["NIM"] ?></td>
                            <td><?= $mhs["nama"] ?></td>
                            <td><a class="btn btn-warning btn-sm" href="data_mhs_doswalskripsi.php?id=<?= $mhs["id_mhs"]; ?>">Detail</a>&nbsp;&nbsp;
                            </td>
                        </tr>
                        <?php $i++;?>
                        <?php endforeach; ?>
