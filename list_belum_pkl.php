        ...
        <div class="container bg-white">
            <div class="row">
                ...
                <ul class="nav nav-pills justify-content-center text-dark">
                    ...
                    <li class="nav-item"><a href="list_sudah_pkl.php" class="nav-link text-dark"><b>Data Mahasiswa Sudah PKL</b></a></li>
                    <li class="nav-item"><a href="#" class="nav-link active" aria-current="page" style="background-color:grey"><b>Data Mahasiswa Belum PKL</b></a></li>
                </ul>
                    <form method="POST" autocomplete="on" action="">
                        ...
                        if (isset($_POST["upload"])) {
                            $query = klik4($_POST["upload"]);
                        }
                        if (isset($_POST["semua"])) {
                            $query = semua4($_POST["semua"]);
                        }
                        ...
                        <tr>
                            ...
                            <td><?= $mhs["NIM"] ?></td>
                            <td><?= $mhs["nama"] ?></td>
                            <td><a class="btn btn-warning btn-sm" href="data_mhs_deptblmpkl.php?id=<?= $mhs["id_mhs"]; ?>">Detail</a>
                            </td>
                        </tr>
                        <?php $i++;?>
                        <?php endforeach; ?>
