...
<body style="background-color:#f3f3f3"">
    ...
    <div class="me-5 ms-5">
        ...
        <ul class="nav nav-pills justify-content-center text-dark">
            ...
            <li class="nav-item"><a href="entry_pkl.php" class="nav-link active" aria-current="page" style="background-color:#101E31"><b>Data PKL</b></a></li>
            ...
            <div class="row">
                ...
                <div class="col-sm">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <br><br>
                        <br><br>
                        <input type="hidden" name="id_pkl" value="<?= $mhs["id_pkl"]; ?>">
                        <div class="mb-3 row mt-4">
                            <label for="status_pkl" class="col-sm-4 col-form-label">Status PKL :</label>
                            <div class="col-sm-5">
                                <input type="text" name="status_pkl" class="form-control" id="status_pkl" value="<?= $mhs["status_pkl"]; ?>">
                            </div>

                        </div>
                        <div class="mb-3 row">
                            <label for="nilai_pkl" class="col-sm-4 col-form-label">Nilai PKL :</label>
                            <div class="col-sm-5">
                                <input type="text" name="nilai_pkl" class="form-control" id="nilai_pkl" value="<?= $mhs["nilai_pkl"]; ?>">
                            </div>
                        </div>
                        <br>
                </div>
