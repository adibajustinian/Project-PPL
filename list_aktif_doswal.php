...
<body style="background-color:#f3f3f3"">
    ...
    <div class="me-5 ms-5">
        ...
        <!-- <ul class="nav nav-pills justify-content-center text-dark">
            ...
            <li class="nav-item"><a href="list_aktiff.php" class="nav-link active" aria-current="page" style="background-color:#101E31"><b>Data Mahasiswa</b></a></li>
        ...
        <div class="container bg-white">
            ...
            <div class="row">
                ...
                <!-- <div class="nav nav-pills justify-content-center text-dark">
                    <li class="nav-item"><a href="#.php" class="nav-link active" aria-current="page" style="background-color:#101E31" ><b>Kembali</b></a></li>
                </div> -->
                <ul class="nav nav-pills justify-content-center text-dark">
                    <!-- <li class="nav-item"><a href="#.php" class="nav-link active" aria-current="page" style="background-color:#101E31" ><b>Kembali</b></a></li> -->
                    ...
                    <li class="nav-item"><a href="list_tidak_aktif_doswal.php" class="nav-link text-dark"><b>Data Mahasiswa Tidak Aktif</b></a></li>
                </ul>
                    <form method="POST" autocomplete="on" action="">
                        ...
                        // Execute the query
                        $query = query(" SELECT id_mhs,NIM,nama,status FROM mahasiswa WHERE status = 'AKTIF' AND nama_doswal='Dr. Aris Puji Widodo, S.Si, M.T'");
                        
                        if (isset($_POST["upload"])) {
                            $query = klik13($_POST["upload"]);
                        }
                        if (isset($_POST["semua"])) {
                            $query = semua13($_POST["semua"]);
                        }
                        ...
                        <tr>
                            ...
                            <td><?= $mhs["NIM"] ?></td>
                            <td><?= $mhs["nama"] ?></td>
                            <td><a class="btn btn-warning btn-sm" href="data_mhs_doswalaktif.php?id=<?= $mhs["id_mhs"]; ?>">Detail</a>
                            </td>
                        </tr>
                        <?php $i++;?>
                        <?php endforeach; ?>
