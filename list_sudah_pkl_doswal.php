<!--
    Nama file: list_sudah_pkl.php.php
    fungsi: Halaman untuk departemen melihat data mahasiswa yang sudah lulus PKL pada sistem
-->
<html lang="en">
...
<body style="background-color:#f3f3f3">
    ...
    <div class="me-5 ms-5">
        ...
        <ul class="nav nav-pills justify-content-center text-dark">
            ...
            <li class="nav-item"><a href="rekap_pkl_doswal" class="nav-link active" aria-current="page" style="background-color:#101E31"><b>Data Mahasiswa PKL</b></a></li>
        ...
        <div class="container bg-white">
            ...
            <div class="col-sm-8">
                ...
                <ul class="nav nav-pills justify-content-center text-dark">
                    ...
                    <li class="nav-item"><a href="list_sudah_pkl_doswal.php" class="nav-link active" aria-current="page" style="background-color:grey"><b>Data Mahasiswa Sudah PKL</b></a></li>
                    <li class="nav-item"><a href="list_belum_pkl_doswal.php" class="nav-link text-dark"><b>Data Mahasiswa Belum PKL</b></a></li>
                </ul>
                    <form method="POST" autocomplete="on" action="">
                        ...
                        ON pkl.id_mhs = mahasiswa.id_mhs WHERE status_pkl = 'Sudah PKL' AND nama_doswal='Dr. Aris Puji Widodo, S.Si, M.T'");
                        
                        if (isset($_POST["upload"])) {
                            $query = klik10($_POST["upload"]);
                        }
                        if (isset($_POST["semua"])) {
                            $query = semua10($_POST["semua"]);
                        }
                        ...
                        <tr>
                            ...
                            <td><?= $mhs["NIM"] ?></td>
                            <td><?= $mhs["nama"] ?></td>
                            <td><a class="btn btn-warning btn-sm" href="data_mhs_doswalpkl.php?id=<?= $mhs["id_mhs"]; ?>">Detail</a>&nbsp;&nbsp;
                            </td>
                        </tr>
                        <?php $i++;?>
                        <?php endforeach; ?>
