...
<body style="background-color:#f3f3f3">
    ...
    <div class="me-5 ms-5">
        ...
        <ul class="nav nav-pills justify-content-center text-dark">
            ...
            <li class="nav-item"><a href="#" class="nav-link active" aria-current="page" style="background-color:#101E31"><b>Data Mahasiswa PKL</b></a></li>
        ...
        <div class="container bg-white">
            ...
            <div class="col-sm-8">
                    <br>
                <ul class="nav nav-pills justify-content-center text-dark">
                    <li class="nav-item"><a href="rekap_pkl.php" class="nav-link text-dark"><b>Rekap Data PKL Mahasiswa</b></a></li>
                    <li class="nav-item"><a href="list_sudah_pkl.php" class="nav-link active" aria-current="page" style="background-color:grey"><b>Data Mahasiswa Sudah PKL</b></a></li>
                    <li class="nav-item"><a href="list_belum_pkl.php" class="nav-link text-dark"><b>Data Mahasiswa Belum PKL</b></a></li>
                </ul>
                    <form method="POST" autocomplete="on" action="">
                        ...
                        if (isset($_POST["upload"])) {
                            $query = klik3($_POST["upload"]);
                        }
                        if (isset($_POST["semua"])) {
                            $query = semua3($_POST["semua"]);
                        }
                        ...
                        <tr>
                            ...
                            <td><?= $mhs["NIM"] ?></td>
                            <td><?= $mhs["nama"] ?></td>
                            <td><a class="btn btn-warning btn-sm" href="data_mhs_deptsdhpkl.php?id=<?= $mhs["id_mhs"]; ?>">Detail</a>
                            </td>
                        </tr>
                        <?php $i++;?>
                        <?php endforeach; ?>
