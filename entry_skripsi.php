...
<body style="background-color:#f3f3f3"">
    ...
    <div class="me-5 ms-5">
        ...
        <ul class="nav nav-pills justify-content-center text-dark">
            ...
            <li class="nav-item"><a href="entry_skripsi.php" class="nav-link active" aria-current="page" style="background-color:#101E31"><b>Data Skripsi</b></a></li>
        </ul>
            ...
            <div class="row">
                ...
                <div class="col-sm">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <br><br>
                        <br><br>
                        <input type="hidden" name="id_skripsi" value="<?= $mhs["id_skripsi"]; ?>">
                        <div class="mb-3 row mt-4">
                            <label for="status_skripsi" class="col-sm-4 col-form-label">Status Skripsi :</label>
                            <div class="col-sm-5">
                                <input type="text" name="status_skripsi" class="form-control" id="status_skripsi" value="<?= $mhs["status_skripsi"]; ?>">
                            </div>

                        </div>
                        <div class="mb-3 row">
                            <label for="nilai_skripsi" class="col-sm-4 col-form-label">Nilai Skripsi :</label>
                            <div class="col-sm-5">
                                <input type="text" name="nilai_skripsi" class="form-control" id="nilai_skripsi" value="<?= $mhs["nilai_skripsi"]; ?>">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="lama_studi" class="col-sm-4 col-form-label">Lama Studi :</label>
                            <div class="col-sm-5">
                                <input type="text" name="lama_studi" class="form-control" id="lama_studi" value="<?= $mhs["lama_studi"]; ?>">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="tanggal_sidang" class="col-sm-4 col-form-label">Tanggal Sidang :</label>
                            <div class="col-sm-5">
                                <input type="text" name="tanggal_sidang" class="form-control" id="tanggal_sidang" value="<?= $mhs["tanggal_sidang"]; ?>">
                            </div>
                        </div>
                        <br>
                </div>
