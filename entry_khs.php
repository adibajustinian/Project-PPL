...
<body style="background-color:#f3f3f3"">
    ...
    <div class="me-5 ms-5">
        ...
        <ul class="nav nav-pills justify-content-center text-dark">
            ...
            <li class="nav-item"><a href="entry_khs.php" class="nav-link active" aria-current="page" style="background-color:#101E31"><b>Data KHS</b></a></li>
            ...
            <div class="row">
                ...
                <div class="col-sm">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <br><br>
                        <br><br>
                        <input type="hidden" name="id_khs" value="<?= $mhs["id_khs"]; ?>">
                        <div class="mb-3 row mt-4">
                            <label for="SKS_semester" class="col-sm-4 col-form-label">Jumlah SKS Semester :</label>
                            <div class="col-sm-5">
                                <input type="text" name="SKS_semester" class="form-control" id="SKS_semester" value="<?= $mhs["SKS_semester"]; ?>">
                            </div>

                        </div>
                        <div class="mb-3 row">
                            <label for="IP_smt" class="col-sm-4 col-form-label">IP semester :</label>
                            <div class="col-sm-5">
                                <input type="text" name="IP_smt" class="form-control" id="IP_smt"  value="<?= $mhs["IP_smt"]; ?>">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="SKS_kumulatif" class="col-sm-4 col-form-label">Jumlah SKS kumulatif :</label>
                            <div class="col-sm-5">
                                <input type="text" name="SKS_kumulatif" class="form-control" id="SKS_kumulatif" value="<?= $mhs["SKS_kumulatif"]; ?>">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="IP_kumulatif" class="col-sm-4 col-form-label">IP Kumulatif :</label>
                            <div class="col-sm-5">
                                <input type="text" name="IP_kumulatif" class="form-control" id="IP_kumulatif" value="<?= $mhs["IP_kumulatif"]; ?>">
                            </div>
                        </div>
                        <br>
                </div>
