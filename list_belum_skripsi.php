<!--
    Nama file: list_belum_kripsi.php
    fungsi: Halaman untuk departemen melihat data mahasiswa yang blm mengambil skripsi pada sistem
-->
<html lang="en">
...
<body style="background-color:#f3f3f3"">
    ...
    <div class="me-5 ms-5">
        ...
        <ul class="nav nav-pills justify-content-center text-dark">
            ...
            <li class="nav-item"><a href="#" class="nav-link active" aria-current="page" style="background-color:#101E31"><b>Data Mahasiswa Skripsi</b></a></li>
        </ul>
        ...
        <div class="container bg-white">
            <div class="row">
                ...
                <div class="col-sm-8">
                    <br>
                <ul class="nav nav-pills justify-content-center text-dark">
                    <li class="nav-item"><a href="rekap_skripsi.php" class="nav-link text-dark"><b>Rekap Data Skripsi Mahasiswa</b></a></li>
                    <li class="nav-item"><a href="list_sudah_skripsi.php" class="nav-link text-dark"><b>Data Mahasiswa Sudah Skripsi</b></a></li>
                    <li class="nav-item"><a href="#" class="nav-link active"  aria-current="page" style="background-color:grey"><b>Data Mahasiswa Belum Skripsi</b></a></li>
                </ul>
                <form method="POST" autocomplete="on" action="">
                        ...
                        // Execute the query
                        $query = query(" SELECT mahasiswa.id_mhs,NIM,nama,status_skripsi FROM skripsi INNER JOIN mahasiswa
                        ON skripsi.id_mhs = mahasiswa.id_mhs WHERE status_skripsi = 'Belum SKRIPSI'");
                        
                        if (isset($_POST["upload"])) {
                            $query = klik5($_POST["upload"]);
                        }
                        if (isset($_POST["semua"])) {
                            $query = semua5($_POST["semua"]);
                        }
                        ...
                        <tr>
                            ...
                            <td><?= $mhs["NIM"] ?></td>
                            <td><?= $mhs["nama"] ?></td>
                            <td><a class="btn btn-warning btn-sm" href="data_mhs_deptsdhskripsi.php?id=<?= $mhs["id_mhs"]; ?>">Detail</a>
                            </td>
                        </tr>
                        <?php $i++;?>
                        <?php endforeach; ?>
