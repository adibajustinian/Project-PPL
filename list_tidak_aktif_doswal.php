...
<body style="background-color:#f3f3f3"">
    ...
    <div class="me-5 ms-5">
        ...
        <!-- <ul class="nav nav-pills justify-content-center text-dark">
            <li class="nav-item"><a href="#" class="nav-link text-dark"><b>Home</b></a></li>
            <li class="nav-item"><a href="entry_pkl.php" class="nav-link active" aria-current="page" style="background-color:#101E31"><b>Data Mahasiswa</b></a></li>
            <li class="nav-item"><a href="entry_irs.php" class="nav-link text-dark"><b>Data Mahasiswa PKL</b></a></li>
            <li class="nav-item"><a href="entry_skripsi.php" class="nav-link text-dark"><b>Data Mahasiswa Skripsi</b></a></li>
        </ul> -->
        ...
        <div class="container bg-white">
            <div class="row">
                ...
                <div class="col-sm">
                    <br>
                <ul class="nav nav-pills justify-content-center text-dark">
                    <li class="nav-item"><a href="list_aktif_doswal.php" class="nav-link text-dark"><b>Data Mahasiswa Aktif</b></a></li>
                    <li class="nav-item"><a href="list_tidak_aktif_doswal.php" class="nav-link active" aria-current="page" style="background-color:grey"><b>Data Mahasiswa Tidak Aktif</b></a></li>
                </ul>
                    <form method="POST" autocomplete="on" action="">
                        ...
                        // Execute the query
                        $query = query(" SELECT mahasiswa.id_mhs,NIM,nama,status FROM mahasiswa WHERE status != 'AKTIF' AND nama_doswal='Dr. Aris Puji Widodo, S.Si, M.T'");
                        
                        if (isset($_POST["upload"])) {
                            $query = klik12($_POST["upload"]);
                        }
                        if (isset($_POST["semua"])) {
                            $query = semua12($_POST["semua"]);
                        }
                        ...
                        <tr>
                            ...
                            <td><?= $mhs["NIM"] ?></td>
                            <td><?= $mhs["nama"] ?></td>
                            <td><a class="btn btn-warning btn-sm" href="data_mhs_doswaltdkaktif.php?id=<?= $mhs["id_mhs"]; ?>">Detail</a>
                            </td>
                        </tr>
                        <?php $i++;?>
                        <?php endforeach; ?>
                ...
                <form action="" method="post">
                    ...
                    <div class="nav nav-pills justify-content-center text-dark">
                        <li class="nav-item"><a href="dashboard_doswal.php" class="nav-link active" aria-current="page" style="background-color:#101E31" ><b>Kembali ke Home</b></a></li>
                    </div>
                    </form>
                    <br><br>
                </div>
